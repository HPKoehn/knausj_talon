...
default_alphabet = "angel bat cap drum each fine gust harp sit jury crunch look maid near odd pit quench red sun trap urge vest whale plex yank zip".split(
    " "
)
